...
const OrderProductList = ({ className, orderData, withHeader, showConfigurableOptions, }) => {
    ...
    return (<div className={(0, lib_1.classes)(['order-order-product-list', className])}>
      <components_1.OrderProductListContent loading={loading} taxConfig={taxConfig} order={order} withHeader={withHeader} showConfigurableOptions={showConfigurableOptions}/>
    </div>);
};
