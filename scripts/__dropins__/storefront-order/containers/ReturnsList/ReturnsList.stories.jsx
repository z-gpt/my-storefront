...
exports.MinifiedViewReturns = {
    render: () => {
        ...
        <components_1.ReturnsListContent returnsInMinifiedView={1} minifiedView={true} withThumbnails={true} withHeader={true} withReturnsListButton={true} translations={translations} returnOrderList={mock_config_1.returnOrderListMock}/>
      </div>);
    },
};
exports.FullSizeViewReturns = {
    render: () => {
        ...
        return (<div style={{ maxWidth: '1200px', margin: '50px auto' }}>
        <components_1.ReturnsListContent withThumbnails={true} translations={translations} returnOrderList={mock_config_1.returnOrderListMock} pageInfo={{ pageSize: 1, totalPages: 1, currentPage: 1 }} selectedPage={1}/>
      </div>);
    },
};
exports.FullSizeViewReturnsImageClick = {
    render: () => {
        ...
        return (<div style={{ maxWidth: '1200px', margin: '50px auto' }}>
        <components_1.ReturnsListContent withThumbnails={true} translations={translations} returnOrderList={mock_config_1.returnOrderListMock} pageInfo={{ pageSize: 1, totalPages: 1, currentPage: 1 }} selectedPage={1} routeProductDetails={() => 'https://adobe.com'}/>
      </div>);
    },
};
exports.FullSizeViewReturnsPagination = {
    render: () => {
        ...
        return (<div style={{ maxWidth: '1200px', margin: '50px auto' }}>
        <components_1.ReturnsListContent withThumbnails={true} translations={translations} returnOrderList={mock_config_1.returnOrderListMock} pageInfo={{ pageSize: 10, totalPages: 2, currentPage: 1 }} selectedPage={1}/>
      </div>);
    },
};
