...
`,zn=async({orderId:n,returnRef:i,queryType:u,returnsPageSize:c=50})=>await fn(Ln,{method:"GET",cache:"force-cache",variables:{orderNumber:n,pageSize:c}}).then(_=>$n(u??"orderData",_,i)).catch(nn),Wn=`
  ...
  ${yn}
  ${an}
`,Yn=async(n,i)=>await fn(Wn,{method:"GET",cache:"no-cache",variables:{token:n}}).then(u=>{var c;return(c=u.errors)!=null&&c.length&&u.errors[0].message==="Please login to view the order."?vn(u.errors):Bn(u,i)}).catch(nn),Qn="orderData",Kn=async n=>{var g;const i=typeof(n==null?void 0:n.orderRef)=="string"?n==null?void 0:n.orderRef:"",u=typeof(n==null?void 0:n.returnRef)=="string"?n==null?void 0:n.returnRef:"",c=i&&typeof(n==null?void 0:n.orderRef)=="string"&&((g=n==null?void 0:n.orderRef)==null?void 0:g.length)>20,_=(n==null?void 0:n.orderData)??null;if(_){Z.emit("order/data",{..._,returnNumber:u});return}if(!i)return;const l=c?await Yn(i,u):await zn({orderId:i,returnRef:u,queryType:Qn});l?Z.emit("order/data",{...l,returnNumber:u}):Z.emit("order/error",{source:"order",type:"network",error:"The data was not received."})},bn=new Tn({init:async n=>{const i={};bn.config.setConfig({...i,...n}),Kn(n??{}).catch(console.error)},listeners:()=>[]}),U=bn.config;export{D as a,Jn as b,Yn as c,U as d,zn as g,bn as i,Cn as t};
