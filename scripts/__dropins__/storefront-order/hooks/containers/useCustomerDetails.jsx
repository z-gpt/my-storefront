...
const formatAddressFields_1 = require("@/order/lib/formatAddressFields");
...
const useCustomerDetails = ({ orderData }) => {
    ...
    const normalizeAddress = (0, hooks_1.useMemo)(() => ({
        billingAddress: (0, formatAddressFields_1.formatAddressFields)(getNormalizeAddress('billingAddress')),
        shippingAddress: (0, formatAddressFields_1.formatAddressFields)(getNormalizeAddress('shippingAddress')),
    }), [getNormalizeAddress]);
