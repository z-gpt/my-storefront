...
const useOrderProductList_1 = require("./useOrderProductList");
...
describe('[ORDER-HOOKS] - useOrderProductList', () => {
    test('should return order hook prop', () => {
        ...
        const { result } = (0, react_hooks_1.renderHook)(() => (0, useOrderProductList_1.useOrderProductList)({ orderData: mock_config_1.transformMockOrderOutput }));
    ...
    test('should return order/data with events => emit', () => {
        ...
        const { result } = (0, react_hooks_1.renderHook)(() => (0, useOrderProductList_1.useOrderProductList)({ orderData: null }));
        expect(result.current.order).toBe(mock_config_1.transformMockOrderOutput);
    });
});
