...
const OrderCancelReasonsForm = ({ pickerProps, submitButtonProps, cancelReasons, cancelOrder, orderId, }) => {
    ...
    const onSubmit = async (event) => {
        event.preventDefault();
        return cancelOrder(orderId, cancelReasons[selectedReason].text, (data) => {
    ...
    return (<>
      <components_2.Form onSubmit={onSubmit} data-testid="order-order-cancel-reasons-form__text">
        ...
        <div className="order-order-cancel-reasons-form__button-container">
          <components_1.Button variant="primary" {...submitButtonProps}>
