...
export declare class BalanceControlAPI extends Service {
    ...
    */
    balanceTransfer(balanceTransferRequest: BalanceTransferRequest, requestOptions?: IRequest.Options): Promise<BalanceTransferResponse>;
}
