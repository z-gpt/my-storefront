...
exports.PaymentInstrumentGroupsApi = void 0;
const getJsonResponse_1 = __importDefault(require("../../helpers/getJsonResponse"));
const service_1 = __importDefault(require("../../service"));
const models_1 = require("../../typings/balancePlatform/models");
const resource_1 = __importDefault(require("../resource"));
class PaymentInstrumentGroupsApi extends service_1.default {
    constructor(client) {
        super(client);
    ...
    */
    async createPaymentInstrumentGroup(paymentInstrumentGroupInfo, requestOptions) {
        const endpoint = `${this.baseUrl}/paymentInstrumentGroups`;
        const resource = new resource_1.default(this, endpoint);
        const request = models_1.ObjectSerializer.serialize(paymentInstrumentGroupInfo, "PaymentInstrumentGroupInfo");
        const response = await (0, getJsonResponse_1.default)(resource, request, { ...requestOptions, method: "POST" });
        return models_1.ObjectSerializer.deserialize(response, "PaymentInstrumentGroup");
    }
    /**
    ...
    */
    async getAllTransactionRulesForPaymentInstrumentGroup(id, requestOptions) {
    ...
    * @return {@link PaymentInstrumentGroup }
    */
    async getPaymentInstrumentGroup(id, requestOptions) {
...
exports.PaymentInstrumentGroupsApi = PaymentInstrumentGroupsApi;
//# sourceMappingURL=paymentInstrumentGroupsApi.js.map