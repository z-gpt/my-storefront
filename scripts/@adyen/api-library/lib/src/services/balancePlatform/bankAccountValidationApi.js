...
exports.BankAccountValidationApi = void 0;
const getJsonResponse_1 = __importDefault(require("../../helpers/getJsonResponse"));
const service_1 = __importDefault(require("../../service"));
const models_1 = require("../../typings/balancePlatform/models");
const resource_1 = __importDefault(require("../resource"));
class BankAccountValidationApi extends service_1.default {
    constructor(client) {
        super(client);
    ...
    */
    async validateBankAccountIdentification(bankAccountIdentificationValidationRequest, requestOptions) {
        const endpoint = `${this.baseUrl}/validateBankAccountIdentification`;
        const resource = new resource_1.default(this, endpoint);
        const request = models_1.ObjectSerializer.serialize(bankAccountIdentificationValidationRequest, "BankAccountIdentificationValidationRequest");
        await (0, getJsonResponse_1.default)(resource, request, { ...requestOptions, method: "POST" });
    }
}
exports.BankAccountValidationApi = BankAccountValidationApi;
//# sourceMappingURL=bankAccountValidationApi.js.map