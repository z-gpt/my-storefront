...
export declare class TerminalSettingsCompanyLevelApi extends Service {
    ...
    * @return {@link Logo }
    */
    getTerminalLogo(companyId: string, model?: string, requestOptions?: IRequest.Options): Promise<Logo>;
    /**
    ...
    * @return {@link Logo }
    */
    updateTerminalLogo(companyId: string, logo: Logo, model?: string, requestOptions?: IRequest.Options): Promise<Logo>;
    /**
