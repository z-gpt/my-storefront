...
import { SplitConfiguration, SplitConfigurationList, SplitConfigurationRule, UpdateSplitConfigurationLogicRequest, UpdateSplitConfigurationRequest, UpdateSplitConfigurationRuleRequest } from "../../typings/management/models";
