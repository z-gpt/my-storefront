...
export declare class APIKeyCompanyLevelApi extends Service {
    ...
    */
    generateNewApiKey(companyId: string, apiCredentialId: string, requestOptions?: IRequest.Options): Promise<GenerateApiKeyResponse>;
}
