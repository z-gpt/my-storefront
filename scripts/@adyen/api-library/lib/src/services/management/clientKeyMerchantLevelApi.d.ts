...
export declare class ClientKeyMerchantLevelApi extends Service {
    ...
    */
    generateNewClientKey(merchantId: string, apiCredentialId: string, requestOptions?: IRequest.Options): Promise<GenerateClientKeyResponse>;
}
