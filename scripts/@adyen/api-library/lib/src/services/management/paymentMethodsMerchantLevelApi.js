...
class PaymentMethodsMerchantLevelApi extends service_1.default {
    ...
    */
    async getAllPaymentMethods(merchantId, storeId, businessLineId, pageSize, pageNumber, requestOptions) {
        var _a, _b;
        const endpoint = `${this.baseUrl}/merchants/{merchantId}/paymentMethodSettings`
            .replace("{" + "merchantId" + "}", encodeURIComponent(String(merchantId)));
        const resource = new resource_1.default(this, endpoint);
        const hasDefinedQueryParams = (_b = (_a = storeId !== null && storeId !== void 0 ? storeId : businessLineId) !== null && _a !== void 0 ? _a : pageSize) !== null && _b !== void 0 ? _b : pageNumber;
        if (hasDefinedQueryParams) {
            ...
            if (storeId)
                requestOptions.params["storeId"] = storeId;
            if (businessLineId)
                requestOptions.params["businessLineId"] = businessLineId;
            if (pageSize)
