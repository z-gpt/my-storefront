...
export declare class TerminalOrdersCompanyLevelApi extends Service {
    ...
    */
    listBillingEntities(companyId: string, name?: string, requestOptions?: IRequest.Options): Promise<BillingEntitiesResponse>;
    /**
    ...
    */
    listOrders(companyId: string, customerOrderReference?: string, status?: string, offset?: number, limit?: number, requestOptions?: IRequest.Options): Promise<TerminalOrdersResponse>;
    /**
    ...
    */
    listShippingLocations(companyId: string, name?: string, offset?: number, limit?: number, requestOptions?: IRequest.Options): Promise<ShippingLocationsResponse>;
    /**
    ...
    */
    listTerminalProducts(companyId: string, country?: string, terminalModelId?: string, offset?: number, limit?: number, requestOptions?: IRequest.Options): Promise<TerminalProductsResponse>;
    /**
