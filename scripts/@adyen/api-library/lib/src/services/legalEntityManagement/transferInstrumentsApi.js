...
class TransferInstrumentsApi extends service_1.default {
    ...
    */
    async createTransferInstrument(transferInstrumentInfo, requestOptions) {
        ...
        const request = models_1.ObjectSerializer.serialize(transferInstrumentInfo, "TransferInstrumentInfo");
        const response = await (0, getJsonResponse_1.default)(resource, request, { ...requestOptions, method: "POST" });
        return models_1.ObjectSerializer.deserialize(response, "TransferInstrument");
    }
    /**
