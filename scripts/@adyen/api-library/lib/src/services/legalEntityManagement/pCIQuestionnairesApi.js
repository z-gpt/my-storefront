...
class PCIQuestionnairesApi extends service_1.default {
    ...
    */
    async calculatePciStatusOfLegalEntity(id, calculatePciStatusRequest, requestOptions) {
        ...
        const request = models_1.ObjectSerializer.serialize(calculatePciStatusRequest, "CalculatePciStatusRequest");
        const response = await (0, getJsonResponse_1.default)(resource, request, { ...requestOptions, method: "POST" });
        return models_1.ObjectSerializer.deserialize(response, "CalculatePciStatusResponse");
    }
    /**
