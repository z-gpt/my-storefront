...
export default class LegalEntityManagementAPI extends Service {
    ...
    get BusinessLinesApi(): BusinessLinesApi;
    get DocumentsApi(): DocumentsApi;
    get HostedOnboardingApi(): HostedOnboardingApi;
    get LegalEntitiesApi(): LegalEntitiesApi;
    get PCIQuestionnairesApi(): PCIQuestionnairesApi;
    get TaxEDeliveryConsentApi(): TaxEDeliveryConsentApi;
    get TermsOfServiceApi(): TermsOfServiceApi;
    get TransferInstrumentsApi(): TransferInstrumentsApi;
}
